...
const date1 = '10/08/2021';
const date2 = '11/03/2021';
...
fs.readFile(postedTransactionsFilename, (err, data) => {
    ...
    lines.forEach(line => {
        ...
        if (trans && trans.date >= new Date(date1.concat(' 00:00:00')) && trans.date <= new Date(date2.concat(' 23:59:59'))) {
            if (!trans.category) {
    ...
    const transactions = transactionArr.filter(t=>t.category === 'supermarket');
